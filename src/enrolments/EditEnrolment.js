    ...
    <>
      ...
      <form onSubmit={submitForm}>
        ...
        <div>
          ...
          <select id="status" value={form.status} name="status" onChange={handleForm} >
        ...
        <div>
          ...
          <select id={courses.id} value={form.course_id} name="course_id" onChange={handleForm}>
        ...
        <div>
          ...
          <select id={lecturers.id} value={form.lecturer_id} name="lecturer_id" onChange={handleForm}>
